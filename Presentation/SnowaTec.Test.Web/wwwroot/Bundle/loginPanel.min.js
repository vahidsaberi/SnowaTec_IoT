...
!(function (a) {
    "function" == typeof define && define.amd
        ? define("jquery.validate.unobtrusive", ["jquery.validate"], a)
    ...
    return (
        (v.unobtrusive = {
            ...
            parse: function (e) {
                ...
                n.find("[data-val=true]").each(function () {
                    v.unobtrusive.parseElement(this, !0);
                }),
                    t.each(function () {
                        var a = u(this);
        ...
        v.addMethod("__dummy__", function (a, e, n) {
            return !0;
        }),
        v.addMethod("regex", function (a, e, n) {
            var t;
            return !!this.optional(e) || ((t = new RegExp(n).exec(a)), t && 0 === t.index && t[0].length === a.length);
        }),
        v.addMethod("nonalphamin", function (a, e, n) {
            var t;
            return n && ((t = a.match(/\W/g)), (t = t && t.length >= n)), t;
        }),
        v.methods.extension ? (m.addSingleVal("accept", "mimtype"), m.addSingleVal("extension", "extension")) : m.addSingleVal("extension", "extension", "accept"),
  ...
  return (function (e) {
    ...
    function (e, t) {
      ...
      var r = {
        ...
        isAndroid: function () {
          return navigator && /android/i.test(navigator.userGoverment);
        },
