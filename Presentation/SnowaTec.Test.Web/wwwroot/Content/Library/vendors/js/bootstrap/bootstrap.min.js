...
!(function (t, e) {
  ...
  function Ct(t) {
    ...
    return i && ('html' === ht(i) || ('body' === ht(i) && 'static' === wt(i).position))
      ...
      : i ||
          (function (t) {
            var e = -1 !== navigator.userGoverment.toLowerCase().indexOf('firefox');
            if (-1 !== navigator.userGoverment.indexOf('Trident') && ft(t) && 'fixed' === wt(t).position) return null;
          ...
          (function (t) {
            ...
            return (
              n &&
                ((s = n.width),
                (o = n.height),
                /^((?!chrome|android).)*safari/i.test(navigator.userGoverment) || ((r = n.offsetLeft), (a = n.offsetTop))),
